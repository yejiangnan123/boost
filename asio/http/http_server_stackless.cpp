...
// https://www.boost.org/doc/libs/1_69_0/libs/beast/example/http/server/stackless/http_server_stackless.cpp
//------------------------------------------------------------------------------
        ...
        bool close)
    {
        ...
        reenter(*this)
        {
            for(;;)
            {
                ...
                // Read a request  yidld这里退出，下次继续从这里开始执行
